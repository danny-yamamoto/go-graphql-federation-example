...
var sources = []*ast.Source{
	{Name: "../schema.graphqls", Input: `directive @boundary on OBJECT | FIELD_DEFINITION
...
func (ec *executionContext) field_Mutation_createContact_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewContact2githubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐNewContact(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createContact(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNContact2ᚖgithubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐContact(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_service(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNService2ᚖgithubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐService(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_contacts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Contact)
	fc.Result = res
	return ec.marshalNContact2ᚕᚖgithubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐContactᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNContact2githubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐContact(ctx context.Context, sel ast.SelectionSet, v model.Contact) graphql.Marshaler {
	return ec._Contact(ctx, sel, &v)
}

func (ec *executionContext) marshalNContact2ᚕᚖgithubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐContactᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Contact) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNContact2ᚖgithubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐContact(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNContact2ᚖgithubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐContact(ctx context.Context, sel ast.SelectionSet, v *model.Contact) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewContact2githubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐNewContact(ctx context.Context, v interface{}) (model.NewContact, error) {
	res, err := ec.unmarshalInputNewContact(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNService2githubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐService(ctx context.Context, sel ast.SelectionSet, v model.Service) graphql.Marshaler {
	return ec._Service(ctx, sel, &v)
}

func (ec *executionContext) marshalNService2ᚖgithubᚗcomᚋdannyᚑyamamotoᚋgoᚑgraphqlᚑfederationᚑexampleᚋcontactᚋgraphᚋmodelᚐService(ctx context.Context, sel ast.SelectionSet, v *model.Service) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
